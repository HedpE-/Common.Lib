...
namespace Common.Lib.HelperClasses
{
    ...
    /// https://stackoverflow.com/a/8341945/5659454
    /// </summary>
    public class XCopy
    {
        ...
        public static void Copy(string source, string destination, bool overwrite, bool nobuffering, EventHandler<System.ComponentModel.ProgressChangedEventArgs> handler)
        {
            new XCopy().CopyInternal(source, destination, overwrite, nobuffering, handler);
        }

        private event EventHandler Completed;
        private event EventHandler<System.ComponentModel.ProgressChangedEventArgs> ProgressChanged;
        ...
        private void CopyInternal(string source, string destination, bool overwrite, bool nobuffering, EventHandler<System.ComponentModel.ProgressChangedEventArgs> handler)
        {
            try
            {
        ...
        private void OnProgressChanged(double percent)
        {
            ...
            if ((int)percent > FilePercentCompleted)
            {
                ...
                if (handler != null)
                    handler(this, new System.ComponentModel.ProgressChangedEventArgs((int)FilePercentCompleted, percent - FilePercentCompleted));
            }
        }
